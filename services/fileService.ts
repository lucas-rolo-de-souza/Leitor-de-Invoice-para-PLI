    ...
    reader.onload = (e) => {
      try {
        ...
        const base64Data = btoa(
          new TextEncoder().encode(fullTextContent).reduce((data, byte) => data + String.fromCharCode(byte), '')
        );
 ...
 */
export const processFilesToBase64 = async (files: File[]): Promise<FilePart[]> => {
