          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[90vh] ring-1 ring-white/20">
              ...
              <div className="flex bg-slate-200/60 p-1 rounded-lg w-full sm:w-auto">
                <button
                  ...
                  className={`flex-1 sm:flex-none px-4 py-1.5 text-xs font-bold rounded-md transition-all shadow-sm ${
                    viewMode === "current"
                      ? "bg-white text-brand-700 ring-1 ring-black/5"
                      ...
                      >
                        ...
                        <td className="px-6 py-3 text-right text-slate-600 font-mono text-xs">
                          <div className="flex items-center justify-end gap-3">
                            <span title="Input" className="text-blue-600/70">
                              {log.inputTokens}
                            </span>
                            <span className="text-slate-300">/</span>
                            <span title="Output" className="text-purple-600/70">
                              {log.outputTokens}
                            </span>
                          </div>
                        </td>
            ...
            <div className="bg-white p-2 border-t border-slate-200 text-center text-[10px] text-slate-400 shrink-0">
              <span className="flex items-center justify-center gap-1">
                <History className="w-3 h-3" /> Armazenamento local
                (LocalStorage). Limpe o histórico para liberar espaço.
              </span>
            </div>
          </div>
        </div>
