...
export const ISO_3166_COUNTRIES: Country[] = [
  ...
  { name: "China", alpha2: "CN", alpha3: "CHN", aliases: ["China"] },
  ...
  { name: "United Arab Emirates", alpha2: "AE", alpha3: "ARE" },
  {
    ...
    alpha2: "GB",
    alpha3: "GBR",
    aliases: ["Reino Unido", "Great Britain", "UK"],
  },
  {
    name: "United States of America",
    alpha2: "US",
    alpha3: "USA",
    aliases: ["Estados Unidos", "USA", "United States"],
  },
