...
export const CHANGE_LOG: ChangeLogItem[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      "Acessibilidade Mobile: Resolvido problema onde campos obrigatórios do modelo PLI (como Cód. Produto e Detalhe) não eram acessíveis em dispositivos móveis.",
      "Melhoria na Validação: Mensagens de erro mais claras ao tentar exportar sem os campos do modelo industrial.",
      "Correção de Layout: Ajuste na largura das colunas da tabela para evitar quebra de linha em resoluções menores.",
    ],
  },
  {
    version: "1.05.00.37",
    date: new Date().toLocaleDateString("pt-BR"),
    changes: [
      "Checklist de Conformidade (Art. 557): Adicionada validação explícita 'IX - Detalhamento Técnico' para garantir preenchimento de Fabricante, Produto e Pesos por item (Modelo PLI).",
  ...
  },
  {
    ...
    date: new Date().toLocaleDateString("pt-BR"),
    changes: [
      "Conformidade Modelo PLI: Implementação completa dos campos obrigatórios do modelo industrial PLI (Código Fabricante, Detalhes do Produto, Atos Legais).",
